...
# KITTI to ROS Bag File Converter
# Original Ver : 
# Modified Ver : 
# Maintain Ver : 
# 
...
# v1.1.0 - Add HDL-64E Ring Channel
# 
# [FUTURE VER]
# v1.2.0 - Add Frame Start - End Clipping (KITTI-Odometry)
...
try:
    ...
    print('[PIP PKG Error] : Need to install PyKTTI - pip install pykitti')
    sys.exit(1)
...
def inv(transform):
    print("Invert rigid body transformation matrix")
    R = transform[0:3, 0:3]
    t = transform[0:3, 3]
    t_inv = -1 * R.T.dot(t)
